...
import playerBg from "../../assets/images/play_bg.jpg";
...
class Player extends Component {
	constructor(props) {
		...
		this.playModes = ["shunxubofang", "danquxunhuan", "ttpodicon"];
	...
	render() {
		...
		let playBg = song.img ? song.img : playerBg;

		//播放按钮样式
		let playButtonClass = this.state.playStatus === true ? "iconfont icon-zanting" : "iconfont icon-bofang";
						...
						<div className="controller-wrapper">
							...
							<div className="play-wrapper">
								<div className="play-model-button" onClick={this.changePlayMode}>
									<i className={"iconfont icon-" + this.playModes[this.state.currentPlayMode]}></i>
								</div>
								...
								<div className="next-button" onClick={this.next}>
									<i className="iconfont icon-shangyishou1"></i>
								</div>
