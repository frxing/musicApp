        ...
        return (
            <div className="music-search">
                ...
                <div
                    ...
                    style={{ display: this.state.w ? "none" : "block" }}
                >
                        ...
                        {this.state.hotKeys.map((hot, index) => {
                            ...
                            return (
                                <div
                                    className="hot-item"
                                    key={index}
                                    onClick={this.handleSearch(hot.k)}
                                >
                                    {hot.k}
                                </div>
                            );
                ...
                <div
                    ...
                    style={{ display: this.state.w ? "block" : "none" }}
                >
                    <Scroll refresh={this.state.refreshScroll} ref="scroll">
                        <div>
                            {/*专辑*/}
                            <div
                            ...
                            {this.state.songs.map(song => {
                                return (
                                    ...
                                    >
                                        <div className="left">
                                            <i className="iconfont icon-yinle3" />
                                        </div>
                                        <div className="right">
                                            <div className="song">
                                                {song.name}
